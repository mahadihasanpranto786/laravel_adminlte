...
<head>
    ...
    <link rel="stylesheet" href="{{ URL::asset('build/assets/app-a87fc204.css') }}">
    <script src="{{ URL::asset('build/assets/app-6e0eadfb.js') }}"></script>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__wobble" src="{{URL::asset("assets/backend/dist/img/AdminLTELogo.png")}}" alt="AdminLTELogo" height="60" width="60">
  </div>
    ...
    <script>
        ...
        function image_preview(image_id, image_src_to_previwe) {
        document.getElementById(image_id)
            .onchange = function(event) {
                let file = event.target.files[0];
                let blobURL = URL.createObjectURL(file);
                document.getElementById(image_src_to_previwe).src = blobURL;
            }

    }
    image_preview("image_file", "image_preview");
    image_preview("image_file1", "image_preview1");
    image_preview("image_file2", "image_preview2");
    image_preview("image_file3", "image_preview3");
    </script>
